                ...
                <div className="border border-gray-200 p-6 bg-gray-50">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <button
                            ...
                            className="bg-coral-500 text-white px-4 py-2 font-bold uppercase text-sm hover:bg-coral-600 self-start rounded shadow-sm transition-colors disabled:opacity-50 flex items-center gap-2"
                        >
                            {isUploadingExcel ? (
                                <>
