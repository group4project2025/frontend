                    ...
                    <div className="border border-gray-100 bg-coral-50/30 rounded-2xl p-6 shadow-sm">
                        ...
                        <form onSubmit={handleUpload} className="space-y-4">
                            ...
                            <button
                                ...
                                className="w-full py-3 bg-coral-500 text-white rounded-xl font-medium hover:bg-coral-600 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                            >
                                {uploading ? (
                                    <>
